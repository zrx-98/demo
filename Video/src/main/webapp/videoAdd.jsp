...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		<form id="infoForm" class="form-horizontal"  method="post" action="Vadd">
		
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">视频标题</label>
				<div class="col-sm-10">
					<input class="form-control" name="title" id="subjectTitle" placeholder="视频名称" type="text">
				</div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
					<select name="speaker_id" id="subjectId" class="form-control">
						<option value="0" selected="selected">请选择所属讲师</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="play_num" id="subjectTitle" placeholder="精确到秒(正整数)" type="text">
				</div>
			</div>
