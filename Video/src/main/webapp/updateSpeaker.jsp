...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="speakerUpdate">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="speaker_name" id="subjectTitle" value="${s.speaker_name }" placeholder="主讲人姓名" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">职位</label>
				<div class="col-sm-10">
					<input class="form-control" name="speaker_job" id="subjectTitle" value="${s.speaker_job }" placeholder="主讲人职位" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">头像地址</label>
				<div class="col-sm-10">
					<input class="form-control" name="head_img_url" id="subjectTitle" value="${s.head_img_url }" placeholder="具体url" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">简介</label>
				<div class="col-sm-10">
					<textarea class="form-control" id="courseDesc" name="speaker_desc" rows="3">${s.speaker_desc }</textarea>
				</div>
			</div>
			<div class="form-group">
